...
void print_usage(int exit_code)
{
    ...
    printf("  --prefix          Mapnik prefix [default %s]\n", "@CMAKE_INSTALL_PREFIX@");
...
int main(int argc, char* argv[])
{
    ...
    {
        print("-L@CMAKE_INSTALL_PREFIX@/@MAPNIK_LIB_DIR@ -l", MAPNIK_LIB_NAME);
    }
    else if (strcmp(argv[1], "--cxxflags") == 0)
    {
        print("@MAPNIK_CMAKE_CXX_FLAGS@");
    }
